...
extern "C" CXDLL_API int ses_write_devices_to_file();
extern "C" CXDLL_API int ses_build_initial_guess(int numRows, int numRowsAct, double* locX , double* locY , double* locZ, double* locActX , double* locActY , double* locActZ, int* bnd, double* x);
