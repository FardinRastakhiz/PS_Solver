*DECK DCOPY_SLATEC
      SUBROUTINE DCOPY_SLATEC (N, DX, INCX, DY, INCY)
C***BEGIN PROLOGUE  DCOPY_SLATEC
C***PURPOSE  Copy a vector.
C***LIBRARY   SLATEC (BLAS)
C***CATEGORY  D1A5
C***TYPE      DOUBLE PRECISION (SCOPY-S, DCOPY_SLATEC-D, CCOPY-C, ICOPY-I)
...
C***END PROLOGUE  DCOPY_SLATEC
      DOUBLE PRECISION DX(*), DY(*)
C***FIRST EXECUTABLE STATEMENT  DCOPY_SLATEC
      IF (N .LE. 0) RETURN
